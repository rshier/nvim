...
hi clear
syntax reset
let g:colors_name = "springfield-x16"

" Highlighting function
function! g:Base16hi(group, ctermfg, ctermbg, attr, guisp)
  if a:ctermfg != ""
...
call <sid>hi("StartifyHeader",   s:cterm0E, "", "", "")
call <sid>hi("StartifyNumber",   s:cterm09, "", "", "")
call <sid>hi("StartifyPath",     s:cterm0A, "", "", "")
